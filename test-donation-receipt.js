...
// Mock donation data - Change currency to 'NGN' to test Nigerian receipt
const mockDonation = {
  _id: '507f1f77bcf86cd799439011',
  reference: 'DON-2024-001',
  totalAmount: 500,
  currency: '$', // Change to 'NGN' or '₦' to test Nigerian version
  isPaid: true,
  source: 'Paystack',
  recurring: false,
  frequency: null,
  areasOfNeed: [
    { name: 'Donations', amount: 300 },
    { name: 'Dues', amount: 100 },
    { name: '6JNC', amount: 100 },
  ],
...
const mockUser = {
  firstName: 'Angela',
  lastName: 'Onime',
  fullName: 'Angela Onime',
  email: 'angelaonime@gmail.com',
  role: 'Member',
  membershipId: 'CMDA-2024-001',
  region: 'Lagos',
};
    ...
    <div class="footer-section">
      <div class="footer-left">
        ...
        <div class="contact-info">
          <strong>Address</strong> - 1928 Woodlawn Drive,<br>
          Woodlawn, Maryland, 21207.<br>
          <strong>Phone</strong> -+1 (443) 557 4199<br>
          <strong>Email</strong>- giv${address.street}<br>
          ${address.city}<br>
...
// Write to file
const outputPath = path.join(__dirname, 'test-donation-receipt.html');
fs.writeFileSync(outputPath, html, 'utf8');

console.log('✅ Receipt generated successfully!');
console.log('📄 File saved to:', outputPath);
console.log('🌐 Open the file in your browser to view the receipt');
