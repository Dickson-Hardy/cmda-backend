        ...
        <tr>
          <td style="padding: 40px 30px">
            ...
            <p style="color: #666666; font-size: 16px; line-height: 1.5; margin: 20px 0">
              You recently requested a new verification code to complete your registration on
              CMDA Nigeria. Please find your verification code below:
            </p>
            <p style="color: #994279; font-size: 28px; font-weight: bold; margin: 20px 0; letter-spacing: 4px;">
              [VerificationCode]
            </p>
            <p style="color: #666666; font-size: 16px; line-height: 1.5; margin: 20px 0">
              Use the verification code above to complete your registration. This code will
              expire in 30 minutes.
            </p>
            <p style="color: #666666; font-size: 16px; line-height: 1.5; margin: 20px 0">
              You are receiving this message because you requested a new verification code on
              CMDA Nigeria. If you did not request this, please ignore this message.
            </p>
            <p style="color: #666666; font-size: 16px; line-height: 1.5; margin: 20px 0">
