export const ADMIN_CREDENTIALS_TEMPLATE = `
        ...
        <tr>
            <td align="center" style="background-color: #994279; padding: 40px 0">
             <img
              ...
              style="display: block"
            />
            <h1 style="color: #ffffff; font-size: 24px; margin-top: 16px">Admin Account Created!</h1>
            </td>
        </tr>
        <!-- Body -->
        <tr>
            ...
            <p style="color: #666666; font-size: 16px; line-height: 1.5; margin: 20px 0">
                An admin account has been created for you on CMDA Nigeria. You can log in using the
                credentials below:
            </p>
            <p
                style="
